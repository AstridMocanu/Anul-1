...
int main(int argc, char *argv[])
{
    ...
    {
        fprintf(stderr,"Eroare la access pentru %s .\t", argv[2]);  perror("Cauza este");
        exit(2);
    }
